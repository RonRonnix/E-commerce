...
async function main() {
  ...
  if (count > 0) {
    ...
    await prisma.product.create({ data: { title: 'Ryzen 7 7800X3D', slug: 'ryzen-7-7800x3d', priceCents: 185000, imageUrl: 'https://picsum.photos/seed/cpu1/600/600', category: { connect: { id: cpu.id } } } as any })
    await prisma.product.create({ data: { title: 'GeForce RTX 4070 Super', slug: 'geforce-rtx-4070-super', priceCents: 349900, imageUrl: 'https://picsum.photos/seed/gpu1/600/600', category: { connect: { id: gpu.id } } } as any })
    await prisma.product.create({ data: { title: 'Corsair Vengeance 32GB DDR5', slug: 'corsair-vengeance-32gb-ddr5', priceCents: 69900, imageUrl: 'https://picsum.photos/seed/ram1/600/600', category: { connect: { id: ram.id } } } as any })
